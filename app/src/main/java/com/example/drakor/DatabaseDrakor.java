...
public class DatabaseDrakor extends SQLiteOpenHelper{
    ...
    public void CreateDrakor (Drakor mdNotif) {
        ...
        values.put(tb_drakor_judul, mdNotif.getmNama());
        values.put(tb_drakor_genre, mdNotif.getmJenis());
    ...
    public List<Drakor> ReadDrakor() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                dataDrakor.setmNama(cursor.getString(1));
                dataDrakor.setmJenis(cursor.getString(2));
